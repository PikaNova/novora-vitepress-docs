...
- [5. 周测计划](/effect/05-weekly)
- [6. 批量与导入](/effect/06-batch-import)
- [7. 快速考试](/effect/07-quick-start)
- [8. PDF 导出](/effect/08-pdf)
...
设备首次使用或需要切换班级时，通过“选择年级与班级”弹窗设置本机显示范围。选择后，这台设备只显示所选班级的周测和适用考试。

![首页-选择年级与班级](/pictures/home-class-select.png)
